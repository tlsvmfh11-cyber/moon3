    ...
    return (
        <footer id="contact" className="bg-midnight-950 pt-24 pb-32 md:pb-12 relative overflow-hidden">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white/5 rounded-2xl p-8 border border-white/5 backdrop-blur-sm">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-xl font-bold text-white">픽업 서비스</h3>
                            </div>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="space-y-4">
                            <a
                                ...
                                className="group flex items-center justify-between p-6 bg-gradient-to-r from-aurora-cyan/20 to-aurora-purple/20 border border-aurora-cyan/30 rounded-2xl hover:from-aurora-cyan/30 hover:to-aurora-purple/30 transition-all"
                                data-testid="link-contact-phone"
                            >
                                <div className="flex items-center gap-4">
                                    <Phone className="text-aurora-cyan w-8 h-8 group-hover:text-white transition-colors" />
                                    <div className="text-left">
                                        <p className="text-sm text-gray-400 font-medium">전화 문의</p>
                                        <p className="text-xl font-bold text-white">010-2303-3778</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <MessageSquare className="text-aurora-purple w-8 h-8 group-hover:text-white transition-colors" />
                                    <div className="text-left">
                                        <p className="text-sm text-gray-400 font-medium">문자 문의</p>
                                        <p className="text-xl font-bold text-white">010-2303-3778</p>
                                    </div>
                                </div>
                            </a>
            ...
            <div className="fixed bottom-6 left-6 right-6 z-50 md:hidden">
                ...
                <div className="flex items-center justify-between gap-2 p-2 border border-white/10 rounded-2xl">
                    <a
                        href="tel:01023033778"
                        className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-aurora-cyan to-aurora-purple rounded-xl text-black font-bold shadow-[0_0_15px_rgba(45,212,191,0.3)] active:scale-95 transition-transform"
